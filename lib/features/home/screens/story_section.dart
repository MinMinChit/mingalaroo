    ...
    return Container(
      ...
      child: Center(
        child: ConstrainedBox(
          ...
          child: Container(
            width: double.infinity,
            padding: EdgeInsets.symmetric(vertical: isMobile ? 60 : 100, horizontal: isMobile ? 20 : 0),
            child: Column(
              children: [
                Text(
                  'Our Story',
                  style: KStyle.tTitleXXL.copyWith(fontSize: isMobile ? 32 : 42),
...
class _StoryItemState extends State<_StoryItem> {
  ...
  Widget build(BuildContext context) {
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        widget.year,
                        style: KStyle.tTitleXL.copyWith(color: KStyle.cPrimary, fontSize: 24),
                      ),
                      const SizedBox(height: 16),
                      Text(
                        widget.text,
                        style: KStyle.tBodyM.copyWith(color: KStyle.cSecondaryText, height: 1.6),
                      ),
                      const SizedBox(height: 40),
                      if (widget.imageA != null || widget.imageB != null)
                        SizedBox(
                          height: 320,
                  ...
                  ).animate(target: _isVisible ? 1 : 0).fadeIn(duration: 600.ms).slideY(begin: 0.05, end: 0),
                ),
              ),
            ],
          ),
    ...
    final textWidget = Padding(
      padding: const EdgeInsets.only(top: 120, bottom: 40), // Align with heart top, add bottom breathing room
      child: Column(
        ...
        children: [
          Text(
            widget.year,
            style: KStyle.tTitleXL.copyWith(color: KStyle.cPrimary, height: 1.0),
        ...
        children: [
          ...
          Expanded(
            child: widget.isTextLeft 
              ? Padding(
                  padding: const EdgeInsets.only(left: 0, right: 20), // Reduced gap to 20
                  child: textWidget,
                )
                .animate(target: _isVisible ? 1 : 0)
              ...
              : Padding(
                  padding: const EdgeInsets.only(right: 40, top: 80), // Added top: 80
                  child: photoWidget,
                ),
          ),
          ...
          Expanded(
            child: !widget.isTextLeft 
              ? Padding(
                  padding: const EdgeInsets.only(left: 20, right: 0), // Reduced gap to 20
                  child: textWidget,
                )
                .animate(target: _isVisible ? 1 : 0)
                .fadeIn(duration: 600.ms)
                .slideX(begin: 0.05, end: 0, duration: 600.ms)
              : Padding(
                  padding: const EdgeInsets.only(left: 40, top: 80), // Added top: 80
                  child: photoWidget,
                ),
          ),
        ],
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          Transform.translate(
            offset: Offset(
              isMobile ? 128 : (isImageOnLeft ? 112 : -112), // 128px separation for 20% overlap
              isMobile ? -25 : -45,
            ),
            child: Transform.rotate(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(4),
                  child: imageB != null 
                    ? Image.asset(imageB!, fit: BoxFit.cover)
          ...
          .fadeIn(duration: isMobile ? 1200.ms : 800.ms, delay: isMobile ? 200.ms : 200.ms)
          .slideX(begin: slideBegin * 0.8, end: 0, 
                  duration: isMobile ? 1200.ms : 800.ms, 
                  curve: Curves.easeOut, delay: isMobile ? 200.ms : 200.ms),

          // Image A (Front)
          // Move to the right (if on right side) or left (if on left side) to reduce overlap
          Transform.translate(
            offset: Offset(
              isMobile ? 0 : (isImageOnLeft ? -112 : 112), // Front at 0 to stay to the right
              0,
            ),
            child: Transform.rotate(
              ...
              child: Container(
                ...
                child: ClipRRect(
                  borderRadius: BorderRadius.circular(4),
                  child: imageA != null 
                    ? Image.asset(imageA!, fit: BoxFit.cover)
          ...
          .animate(target: isVisible ? 1 : 0)
          .fadeIn(duration: isMobile ? 1200.ms : 800.ms, delay: isMobile ? 200.ms : 200.ms)
          .slideX(begin: slideBegin * 1.2, end: 0, 
                  duration: isMobile ? 1200.ms : 800.ms, 
                  curve: Curves.easeOut, delay: isMobile ? 200.ms : 200.ms),
        ],
      ),
        ...
        children: [
          ...
          Column(
            children: [
              ...
              Text(
                'Finally ...',
                style: KStyle.tTitleXXL.copyWith(color: KStyle.cPrimary, fontSize: isMobile ? 32 : 42),
              ...
              .scale(curve: Curves.easeInOutCubic, duration: 1200.ms, begin: const Offset(0.8, 0.8))
              .animate(onPlay: (c) => c.repeat())
              .shimmer(duration: 3000.ms, color: Colors.yellow.withOpacity(0.2)), // Shimmering glow
